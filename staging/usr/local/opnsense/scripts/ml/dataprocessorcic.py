...
# ex: /usr/bin/python3 /usr/local/opnsense/scripts/ml/dataprocessorcic.py --data-source=cic2018/*.csv --batch-size=500 --batch-size-source=1 --num-gpus=0.1 --num-cpus=0.1 --data-destination=cic2018 --tag=cic2018
