...
class Cic2018NormModel(mlflow.pyfunc.PythonModel):
    ...
    def get_input_schema() -> dict:
        schema = {
            FLOW_ID_CIC: pa.string(),
            SRC_IP_CIC: pa.string(),
            SRC_PORT_CIC: pa.float64(),
            SRC_MAC_CIC: pa.string(),
            DST_IP_CIC: pa.string(),
            DST_PORT_CIC: pa.float64(),
            DST_MAC_CIC: pa.string(),
            PROTOCOL_CIC: pa.int32(),
            TIMESTAMP_CIC: pa.string(),
            FLOW_DURATION_CIC: pa.float64(),
            TOT_FWD_PKTS_CIC: pa.float64(),
            TOT_BWD_PKTS_CIC: pa.float64(),
            TOTLEN_FWD_PKTS_CIC: pa.float64(),
            TOTLEN_BWD_PKTS_CIC: pa.float64(),
            FWD_PKT_LEN_MAX_CIC: pa.float64(),
            FWD_PKT_LEN_MIN_CIC: pa.float64(),
            FWD_PKT_LEN_MEAN_CIC: pa.float64(),
            FWD_PKT_LEN_STD_CIC: pa.float64(),
            BWD_PKT_LEN_MAX_CIC: pa.float64(),
            BWD_PKT_LEN_MIN_CIC: pa.float64(),
            BWD_PKT_LEN_MEAN_CIC: pa.float64(),
            BWD_PKT_LEN_STD_CIC: pa.float64(),
            FLOW_BYTS_S_CIC: pa.float64(),
            FLOW_PKTS_S_CIC: pa.float64(),
            FLOW_IAT_MEAN_CIC: pa.float64(),
            FLOW_IAT_STD_CIC: pa.float64(),
            FLOW_IAT_MAX_CIC: pa.float64(),
            FLOW_IAT_MIN_CIC: pa.float64(),
            FWD_IAT_TOT_CIC: pa.float64(),
            FWD_IAT_MEAN_CIC: pa.float64(),
            FWD_IAT_STD_CIC: pa.float64(),
            FWD_IAT_MAX_CIC: pa.float64(),
            FWD_IAT_MIN_CIC: pa.float64(),
            BWD_IAT_TOT_CIC: pa.float64(),
            BWD_IAT_MEAN_CIC: pa.float64(),
            BWD_IAT_STD_CIC: pa.float64(),
            BWD_IAT_MAX_CIC: pa.float64(),
            BWD_IAT_MIN_CIC: pa.float64(),
            FWD_PSH_FLAGS_CIC: pa.float64(),
            BWD_PSH_FLAGS_CIC: pa.float64(),
            FWD_URG_FLAGS_CIC: pa.float64(),
            BWD_URG_FLAGS_CIC: pa.float64(),
            FWD_HEADER_LEN_CIC: pa.float64(),
            BWD_HEADER_LEN_CIC: pa.float64(),
            FWD_PKTS_S_CIC: pa.float64(),
            BWD_PKTS_S_CIC: pa.float64(),
            PKT_LEN_MIN_CIC: pa.float64(),
            PKT_LEN_MAX_CIC: pa.float64(),
            PKT_LEN_MEAN_CIC: pa.float64(),
            PKT_LEN_STD_CIC: pa.float64(),
            PKT_LEN_VAR_CIC: pa.float64(),
            FIN_FLAG_CNT_CIC: pa.float64(),
            SYN_FLAG_CNT_CIC: pa.float64(),
            RST_FLAG_CNT_CIC: pa.float64(),
            PSH_FLAG_CNT_CIC: pa.float64(),
            ACK_FLAG_CNT_CIC: pa.float64(),
            URG_FLAG_CNT_CIC: pa.float64(),
            CWE_FLAG_COUNT_CIC: pa.float64(),
            ECE_FLAG_CNT_CIC: pa.float64(),
            DOWN_UP_RATIO_CIC: pa.float64(),
            PKT_SIZE_AVG_CIC: pa.float64(),
            FWD_SEG_SIZE_AVG_CIC: pa.float64(),
            BWD_SEG_SIZE_AVG_CIC: pa.float64(),
            FWD_BYTS_B_AVG_CIC: pa.float64(),
            FWD_PKTS_B_AVG_CIC: pa.float64(),
            FWD_BLK_RATE_AVG_CIC: pa.float64(),
            BWD_BYTS_B_AVG_CIC: pa.float64(),
            BWD_PKTS_B_AVG_CIC: pa.float64(),
            BWD_BLK_RATE_AVG_CIC: pa.float64(),
            SUBFLOW_FWD_PKTS_CIC: pa.float64(),
            SUBFLOW_FWD_BYTS_CIC: pa.float64(),
            SUBFLOW_BWD_PKTS_CIC: pa.float64(),
            SUBFLOW_BWD_BYTS_CIC: pa.float64(),
            INIT_FWD_WIN_BYTS_CIC: pa.float64(),
            INIT_BWD_WIN_BYTS_CIC: pa.float64(),
            FWD_ACT_DATA_PKTS_CIC: pa.float64(),
            FWD_SEG_SIZE_MIN_CIC: pa.float64(),
            ACTIVE_MEAN_CIC: pa.float64(),
            ACTIVE_STD_CIC: pa.float64(),
            ACTIVE_MAX_CIC: pa.float64(),
            ACTIVE_MIN_CIC: pa.float64(),
            IDLE_MEAN_CIC: pa.float64(),
            IDLE_STD_CIC: pa.float64(),
            IDLE_MAX_CIC: pa.float64(),
            IDLE_MIN_CIC: pa.float64(),
            LABEL_CIC: pa.string(),
        }
