...
class Cic2018NormModel(mlflow.pyfunc.PythonModel):
    ...
    def get_feature_norm() -> dict:
        feature_norm = {
            ...
            # TIMESTAMP: None,
            FLOW_DURATION: norm.norm_time_1m,
            ...
            ACTIVE_MEAN: norm.norm_time_1m,
            ACTIVE_STD: norm.norm_time_1m,
            ACTIVE_MAX: norm.norm_time_1m,
            ACTIVE_MIN: norm.norm_time_1m,
            IDLE_MEAN: norm.norm_time_1m,
            IDLE_STD: norm.norm_time_1m,
            IDLE_MAX: norm.norm_time_1m,
            IDLE_MIN: norm.norm_time_1m,
