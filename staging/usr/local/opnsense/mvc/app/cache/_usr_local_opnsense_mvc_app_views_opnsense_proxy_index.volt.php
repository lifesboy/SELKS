...
<ul class="nav nav-tabs" role="tablist" id="maintabs">
    <?= $this->partial('layout_partials/base_tabs_header', ['formData' => $mainForm]) ?>
...
<div class="content-box tab-content">
    <?= $this->partial('layout_partials/base_tabs_content', ['formData' => $mainForm]) ?>
            ...
            <tr>
                ...
                <td>
                  <div class="hidden" data-for="help_for_proxy.forward.acl.remoteACLs.blacklist">
                      <small>
                      <?= sprintf($lang->_('Add an item to the table to fetch a remote acl for blacklisting.%s
                      You can enable or disable the blacklist list.%s
                      The active blacklists will be merged with the settings under %sForward Proxy -> Access Control List%s.'), '<br/>', '<br/>', '<b>', '</b>') ?>
                      </small>
                  </div>
                </td>
            </tr>
...
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditBlacklist, 'id' => 'DialogEditBlacklist', 'label' => $lang->_('Edit blacklist')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditPACProxy, 'id' => 'DialogEditPACProxy', 'label' => $lang->_('Edit Proxy')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditPACMatch, 'id' => 'DialogEditPACMatch', 'label' => $lang->_('Edit Match')]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditPACRule, 'id' => 'DialogEditPACRule', 'label' => $lang->_('Edit Rule')]) ?>
