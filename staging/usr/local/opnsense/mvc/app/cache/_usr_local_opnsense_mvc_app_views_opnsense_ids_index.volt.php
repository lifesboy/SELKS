...
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogRule, 'id' => 'DialogRule', 'label' => $lang->_('Rule details'), 'hasSaveBtn' => 'true', 'msgzone_width' => 1]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogRuleset, 'id' => 'DialogRuleset', 'label' => $lang->_('Ruleset details'), 'hasSaveBtn' => 'true', 'msgzone_width' => 1]) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogUserDefined, 'id' => 'DialogUserDefined', 'label' => $lang->_('Rule details'), 'hasSaveBtn' => 'true']) ?>
